...
error_reporting(E_ALL ^ E_NOTICE); 
    ...
    $sql=mysql_query("select * from tbl_absen order by id_absen DESC LIMIT 0,1");
       ...
       $query = "insert into tbl_absen (id_kelas, id_siswa, sakit, izin, alfa) values ('$id_kelas','$id_siswa','$sakit','$izin','$alfa')";
...
<div class="ch-container">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Input Ketidakhadiran Siswa</h2>
            ...
            <div class="box-content">
              <form action="nilai_absen_input.php" method="post" role="form">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tr>
                  <td><?php echo $i;?></td>
                    ...
                    <td><?php echo "<input type='text' name='sakit".$i."' size='5' value='-'/>"; ?></td>
                    <td><?php echo "<input type='text' name='izin".$i."' size='5' value='-'/>"; ?></td>
                    <td><?php echo "<input type='text' name='alfa".$i."' size='5' value='-'/>"; ?></td>
                </tr>
                <?php
                  $i++;
                }
