...
<!-- <div class="box col-md-6">
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-home"></i> Data Kelas</h2>
    ...
    <thead>
        <tr>
            <td colspan="8"><a class="btn btn-success" href="javascript: void(0)" onClick="popup1('add_data_kelas.php')">
    ...
    <?php
        ...
        $view=mysql_query("select kelas.id_kelas, kelas.id_guru, kelas.nama_kelas, guru.nama_guru, kelas.username, kelas.password from tbl_kelas kelas, data_guru guru where kelas.id_guru=guru.id_guru order by id_kelas asc");
    ...
    <tr>
        ...
        <td class="center">
            <a href="javascript: void(0)" onClick="popup1('edit_data_kelas.php?id_kelas=<?php echo $row['id_kelas']; ?>')" title="Edit" class="btn btn-info">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a href="delete_data_kelas.php?id_kelas=<?php echo $row['id_kelas']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Apakah Anda Yakin?')">
