...
if(isset($_GET['id_guru'])){
    ...
    if($cek=='0'){
        ...
        ?><script language="javascript">document.location.href="nilai_uh_input.php?id_guru=<?php echo $id_guru;?>&id_jadwal=<?php echo $id_jadwal;?>&id_pelajaran=<?php echo $id_pelajaran;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
    }else{
        //kalo sudah ada mode update
        ?><script language="javascript">document.location.href="nilai_uh_update.php?id_guru=<?php echo $id_guru;?>&id_jadwal=<?php echo $id_jadwal;?>&id_pelajaran=<?php echo $id_pelajaran;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
    }
...
<div class="ch-container">
    ...
    <tr>
        ...
        <td><a href="nilai_uh.php?id_guru=<?php echo $id_guru;?>&id_jadwal=<?php echo $row['id_jadwal'];?>&id_pelajaran=<?php echo $row['id_pelajaran'];?>&id_kelas=<?php echo $row['id_kelas'];?>" title="Pilih Mata Pelajaran"><?php echo $row['nama_pelajaran'];?></a></td>
        <td><?php echo $row['nama_kelas'];?></td>
        <td class="center">
            <a href="javascript: void(0)" onClick="popup_view('laporan_uh.php?id_guru=<?php echo $id_guru;?>&id_jadwal=<?php echo $row['id_jadwal'];?>&id_kelas=<?php echo $row['id_kelas'];?>')" title="Lihat Laporan" class="btn btn-danger">
