...
<!-- <div class="box col-md-6">
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Data Guru</h2>
    ...
    <thead>
        <tr>
            <td colspan="7"><a class="btn btn-success" href="javascript: void(0)" onClick="popup1('add_data_guru.php')">
    ...
    <tr>
        ...
        <td class="center">
            <a href="javascript: void(0)" onClick="popup1('edit_data_guru.php?nip=<?php echo $row['nip']; ?>')" title="Edit" class="btn btn-info">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a href="delete_data_guru.php?id_guru=<?php echo $row['id_guru']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Apakah Anda Yakin?')">
