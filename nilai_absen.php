...
if(isset($_GET['id_kelas'])){
    ...
    $query=mysql_query("select * from tbl_absen where id_kelas='$id_kelas'");
    $cek=mysql_num_rows($query);
    
    if($cek=='0'){
        //kalo belum ada mode input
        ?><script language="javascript">document.location.href="nilai_absen_input.php?id_kelas=<?php echo $id_kelas;?>";</script><?php
    }else{
        //kalo sudah ada mode update
        ?><script language="javascript">document.location.href="nilai_absen_update.php?id_kelas=<?php echo $id_kelas;?>";</script><?php
    }
...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-book"></i> Input Ketidakhadiran Siswa</h2>
    ...
    <tr>
        <th>&nbsp;</th>
        <td><a href="nilai_absen.php?id_kelas=<?php echo $id_kelas;?>" title="Input Nilai" class="btn btn-success">Input</a>
            <a href="laporan_absen.php?id_kelas=<?php echo $id_kelas;?>" class="btn btn-info" title="Lihat Nilai">Lihat Nilai</a>
        </td>
      <td></td>
    </tr>
    </thead>
