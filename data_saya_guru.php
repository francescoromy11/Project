...
<!-- <div class="box col-md-6">
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Data Saya</h2>
    ...
    <tbody>
    <?php
        $view=mysql_query("select * from data_guru where username = '$username'");
    ...
    <tr>
        ...
        <td class="center">
            <a href="javascript: void(0)" onClick="popup_view1('edit_data_saya_guru.php?nip=<?php echo $row['nip']; ?>')" title="Edit" class="btn btn-info">
