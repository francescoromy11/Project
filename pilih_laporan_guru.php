...
<!-- <div class="box col-md-6">
    ...
    <div class="box-header well" data-original-title="">
        ...
        <div class="box-icon">
            ...
            <div class="box-content">
                ...
                <form action="pilih_laporan_guru.php?id_kelas=<?php echo $row3['id_kelas'];?> &nama_pelajaran=<?php echo $row2['nama_pelajaran'];?>" method="post">
                    <div class="form-group">
                        <label>Kelas</label>
                        <div class="controls">
                        <select name="id_kelas" class="styledselect_form_1">
                          ...
                          <?php
                          $kelas=mysql_query("select * from tbl_jadwal jadwal, tbl_kelas kelas where jadwal.id_guru='$id_guru' and jadwal.id_kelas=kelas.id_kelas order by nama_kelas asc");
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <?php
                        $pelajaran=mysql_query("select * from tbl_jadwal jadwal, tbl_pelajaran pelajaran where jadwal.id_guru='$id_guru' and jadwal.id_pelajaran=pelajaran.id_pelajaran order by nama_pelajaran asc");
                        if($pelajaran=== FALSE) { 
                              die(mysql_error()); 
                              }
                        $row2=mysql_fetch_array($pelajaran)
                        ?>
                        <input type="text" class="inp-form" name="nama_pelajaran" value="<?php echo $row2['nama_pelajaran'];?>" disabled="disabled"/>
                    </div>
                    </div>
                    <div class="form-group">
                        <label>Nilai</label>
    ...
    <br><br>
     ...
     <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $view=mysql_query("SELECT * FROM tbl_nilai nilai, data_siswa siswa WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_kelas='$id_kelas' and nilai.id_guru='$id_guru' order by siswa.nama_siswa asc");
    ...
    <?php
        ...
        <input type="text" name="id_jadwal" value="<?php echo $row['id_jadwal'];?>" />
