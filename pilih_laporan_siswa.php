...
<!-- <div class="box col-md-6">
    ...
    <?php
        ...
        $view=mysql_query("select * from tbl_nilai nilai, tbl_jadwal jadwal, tbl_kelas kelas, data_guru guru, tbl_pelajaran pelajaran where nilai.id_kelas=kelas.id_kelas and nilai.id_jadwal=jadwal.id_jadwal and nilai.id_guru=guru.id_guru and nilai.id_pelajaran=pelajaran.id_pelajaran and nilai.id_siswa='$id_siswa' order by nilai.id_jadwal asc");
        if($view=== FALSE) { 
          die(mysql_error()); 
          }
        $no=0;
    ...
    <tr>
        ...
        <td><a href="laporan_nilai_akhir.php?id_guru=<?php echo $row['id_guru'];?>&id_jadwal=<?php echo $row['id_jadwal'];?>&id_kelas=<?php echo $row['id_kelas'];?>" style="color:#0000CC; text-decoration:underline" title="Lihat laporan">Lihat</a></td>
    </tr>
    <?php
        }
    ?>
