        ...
        <div class="box-inner">
            ...
            <div class="box-content">
              ...
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                <?php
                    $view=mysql_query("SELECT * FROM tbl_ekskul ekskul, data_siswa siswa WHERE ekskul.id_siswa=siswa.id_siswa and ekskul.id_kelas='$id_kelas' order by nama_siswa asc");
                    $i = 1;
                    if($view=== FALSE) { 
                                  die(mysql_error()); 
                                  }
                ...
                <tr>
                  <td><?php echo $i;?></td>
                    ...
                    <td><?php echo $row['kegiatan1'];?></td>
                    <td><?php echo $row['nilai1'];?></td>
                    <td><?php echo $row['kegiatan2'];?></td>
                    <td><?php echo $row['nilai2'];?></td>
                    <td><?php echo $row['kegiatan3'];?></td>
