...
<!-- <div class="box col-md-6">
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Data Siswa</h2>
    ...
    <?php 
        $query = "SELECT max(nis) AS last FROM data_siswa";  
        $hasil = mysql_query($query);  
        $data  = mysql_fetch_array($hasil);  
        $lastNoTransaksi = $data['last'];  
          
        // baca nomor urut transaksi dari id transaksi terakhir  
        $lastNoUrut = substr($lastNoTransaksi, 5,10);   
          
        // nomor urut ditambah 1  
        $nextNoUrut = $lastNoUrut + 1;  
        $y= date ("Y");
        // membuat format nomor transaksi berikutnya  
        $kode = "$y".sprintf('%05s', $nextNoUrut);
     ?>
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
    <thead>
        <tr>
            <td colspan="8"><a class="btn btn-success" href="javascript: void(0)" onClick="popup2('add_data_siswa.php?nis=<?php echo $kode; ?>')">
    ...
    <?php
        ...
        $view=mysql_query("select kelas.id_kelas, siswa.nama_siswa, siswa.nis, siswa.kelamin, kelas.nama_kelas, siswa.username, siswa.password from data_siswa siswa, tbl_kelas kelas where siswa.id_kelas = kelas.id_kelas order by nama_siswa asc");
    ...
    <tr>
        ...
        <td class="center">
            <a href="javascript: void(0)" onClick="popup2('edit_data_siswa.php?nis=<?php echo $row['nis']; ?>')" title="Edit" class="btn btn-info">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a href="delete_data_siswa.php?nis=<?php echo $row['nis']; ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Apakah Anda Yakin?')">
