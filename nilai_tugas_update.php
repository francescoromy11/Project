...
error_reporting(E_ALL ^ E_NOTICE); 
  ...
  for ($i=1; $i<=$jumSis; $i++)
  {
     ...
     $query = "update tbl_nilai set nilai_tgs1='$nilai_tgs1', nilai_tgs2='$nilai_tgs2', nilai_tgs3='$nilai_tgs3', nilai_tgs4='$nilai_tgs4', rata_tgs='$rata_tgs', predikat='$predikat', nilai_akhir='$nilai_akhir' where id_siswa='$id_siswa' and id_jadwal='$id_jadwal' and id_kelas='$id_kelas' and id_guru='$id_guru' and id_pelajaran='$id_pelajaran'";
  ...
  if($hasil){
    ...
    ?><script language="javascript">document.location.href="nilai_tugas_selesai.php?status=0";</script><?php
  }
...
<div class="ch-container">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
              <form id="mainform" action="nilai_tugas_update.php" method="post">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tr>
                  ...
                  <td><?php echo "<input type='text' name='nilai_tgs1".$i."' size='10' value='".$row['nilai_tgs1']."'/>"; ?></td>
                  <td><?php echo "<input type='text' name='nilai_tgs2".$i."' size='10' value='".$row['nilai_tgs2']."'/>"; ?></td>
                  <td><?php echo "<input type='text' name='nilai_tgs3".$i."' size='10' value='".$row['nilai_tgs3']."'/>"; ?></td>
                  <td><?php echo "<input type='text' name='nilai_tgs4".$i."' size='10' value='".$row['nilai_tgs4']."'/>"; ?></td>
                  <td><?php echo $row['rata_tgs']; ?></td>
                  <?php echo "<input type='hidden' name='rata_uh".$i."' value='".$row['rata_uh']."' />"; ?>
