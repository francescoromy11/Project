...
error_reporting(E_ALL ^ E_NOTICE); 
    ...
    $uas  = $_POST['uas'.$i];
     ...
     if($nilai_akhir >= 86) $predikat = 'Sangat Baik';
       ...
       $query = "update tbl_nilai set uts='$uts', predikat='$predikat', nilai_akhir='$nilai_akhir' where id_siswa='$id_siswa' and id_jadwal='$id_jadwal' and id_pelajaran='$id_pelajaran' and id_kelas='$id_kelas' and id_guru='$id_guru'";
    ...
    if($hasil){
        ?><script language="javascript">document.location.href="nilai_uts_selesai.php?id_guru=<?php echo $id_guru;?>&id_kelas=<?php echo $id_kelas;?>&id_jadwal=<?php echo $id_jadwal;?>&id_pelajaran=<?php echo $id_pelajaran;?>";</script><?php
    }else{
        ?><script language="javascript">document.location.href="nilai_uts_selesai.php?status=0";</script><?php
    }
...
<div class="ch-container">
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> UTS</h2>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Input Nilai UTS</h2>
            ...
            <div class="box-content">
              <form action="nilai_uts_input.php" method="post" role="form">
