...
error_reporting(E_ALL ^ E_NOTICE); 
    ...
    for ($i=1; $i<=$jumSis; $i++)
    {
       ...
       $query = "update tbl_absen set sakit='$sakit',izin='$izin',alfa='$alfa' where id_siswa='$id_siswa' and id_kelas='$id_kelas'";
       $hasil=mysql_query($query);
       }
    
    if($hasil){
        ?><script language="javascript">document.location.href="nilai_absen_selesai.php?id_kelas=<?php echo $id_kelas;?>";</script><?php
    }else{
        ?><script language="javascript">document.location.href="nilai_absen_selesai.php?status=0";</script><?php
    }
}else{
    unset($_POST['submit']);
}
...
<div class="ch-container">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Input Ketidakhadiran Update</h2>
            ...
            <div class="box-content">
              <form action="nilai_absen_update.php" method="post" role="form">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tbody>
                <?php
                  $view=mysql_query("SELECT * FROM tbl_absen absen, data_siswa siswa WHERE absen.id_siswa=siswa.id_siswa and absen.id_kelas='$id_kelas' order by nama_siswa asc");
                ...
                <tr>
                    ...
                    <td><?php echo "<input type='text' name='sakit".$i."' size='5' value='".$row['sakit']."'/>"; ?></td>
                    <td><?php echo "<input type='text' name='izin".$i."' size='5' value='".$row['izin']."'/>"; ?></td>
                    <td><?php echo "<input type='text' name='alfa".$i."' size='5' value='".$row['alfa']."'/>"; ?></td>
                </tr>
                <?php
                  $i++;
                }
