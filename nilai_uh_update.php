...
error_reporting(E_ALL ^ E_NOTICE); 
  ...
  for ($i=1; $i<=$jumSis; $i++)
  {
     ...
     $nilai_akhir = ((10 * $rata_uh) + (20 * $rata_tgs) + (30 * $uts) + (40 * $uas))/100;
     $kkm = $_POST['kkm'.$i];
     ...
     $query = "update tbl_nilai set nilai_uh1='$nilai_uh1', nilai_uh2='$nilai_uh2', nilai_uh3='$nilai_uh3', nilai_uh4='$nilai_uh4', rata_uh='$rata_uh', predikat='$predikat', nilai_akhir='$nilai_akhir' where id_siswa='$id_siswa' and id_jadwal='$id_jadwal' and id_kelas='$id_kelas' and id_guru='$id_guru' and id_pelajaran='$id_pelajaran'";
  ...
  if($hasil){
    ?><script language="javascript">document.location.href="nilai_uh_selesai.php?id_guru=<?php echo $id_guru;?>&id_kelas=<?php echo $id_kelas;?>&id_jadwal=<?php echo $id_jadwal;?>&id_pelajaran=<?php echo $id_pelajaran;?>";</script><?php
  }else{
    ?><script language="javascript">document.location.href="nilai_uh_selesai.php?status=0";</script><?php
  }
...
<div class="ch-container">
    <div class="row">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="#">Update Nilai Ulangan Harian</a>
            </li>
        </ul>
    </div>
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Ulangan Harian</h2>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Update Nilai Ulangan Harian</h2>
            ...
            <div class="box-content">
              <form id="mainform" action="nilai_uh_update.php" method="post">
              <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                ...
                <tr>
                    ...
                    <th width="15%">NIS</th>
                    <th width="10%">Nilai UH1</th>
                    <th width="10%">Nilai UH2</th>
                    <th width="10%">Nilai UH3</th>
                    <th width="10%">Nilai UH4</th>
                ...
                <tr>
                  ...
                  <td><?php echo "<input type='text' name='nilai_uh1".$i."' size='10' value='".$row['nilai_uh1']."'/>";?></td>
                  <td><?php echo "<input type='text' name='nilai_uh2".$i."' size='10' value='".$row['nilai_uh2']."'/>";?></td>
                  <td><?php echo "<input type='text' name='nilai_uh3".$i."' size='10' value='".$row['nilai_uh3']."'/>";?></td>
                  <td><?php echo "<input type='text' name='nilai_uh4".$i."' size='10' value='".$row['nilai_uh4']."'/>";?></td>
                  <td><?php echo $row['rata_uh']; ?></td>
                  <?php echo "<input type='hidden' name='rata_tgs".$i."' value='".$row['rata_tgs']."' />"; ?>
                  <?php echo "<input type='hidden' name='uts".$i."' value='".$row['uts']."' />"; ?>
                  <?php echo "<input type='hidden' name='uas".$i."' size='10' value='".$row['uas']."'/>"; ?>
                  <?php echo "<input type='hidden' name='nilai_akhir".$i."' size='10' value='".$row['nilai_akhir']."'/>"; ?>
                  <?php echo "<input type='hidden' name='kkm".$i."' size='10' value='".$row['kkm']."'/>"; ?>
                  <?php echo "<input type='hidden' name='predikat".$i."' value='".$row['predikat']."'/>"; ?>
                </tr>
                    <?php
                  $i++;
                }
