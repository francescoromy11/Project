...
error_reporting(E_ALL ^ E_NOTICE); 
    ...
    for ($i=1; $i<=$jumSis; $i++)
    {
     ...
     if($nilai_akhir >= 86) $predikat = 'Sangat Baik';
       ...
       $query = "update tbl_nilai set uas='$uas', predikat='$predikat', nilai_akhir='$nilai_akhir' where id_siswa='$id_siswa' and id_jadwal='$id_jadwal' and id_pelajaran='$id_pelajaran' and id_kelas='$id_kelas' and id_guru='$id_guru'";
       ...
       for ($i=1; $i<=$jumSis; $i++)
        {
        $id_siswa = $_POST['id_siswa'.$i];
       $query = "update tbl_nilai set rata_kelas='$rata_kelas' where id_siswa='$id_siswa' and and id_jadwal='$id_jadwal' and id_pelajaran='$id_pelajaran' and id_kelas='$id_kelas' and id_guru='$id_guru'";
       $hasil=mysql_query($query);
        }
       }
    }
    ...
    if($hasil){
        ?><script language="javascript">document.location.href="nilai_uas_selesai.php?id_guru=<?php echo $id_guru;?>&id_kelas=<?php echo $id_kelas;?>&id_jadwal=<?php echo $id_jadwal;?>&id_pelajaran=<?php echo $id_pelajaran;?>";</script><?php
    }else{
        ?><script language="javascript">document.location.href="nilai_uas_selesai.php?status=0";</script><?php
    }
...
<div class="ch-container">
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> UAS</h2>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
              <form action="nilai_uas_input.php" method="post" role="form">
